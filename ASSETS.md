...
`public/audio/sample-voice.wav` is an AI-generated English greeting made with Azure OpenAI's stock `marin` voice, distributed under the project MIT license and excluded from the SDK npm package.
